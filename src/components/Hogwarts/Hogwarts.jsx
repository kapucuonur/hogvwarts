...
const Hogwarts = ({ data }) => {
  ...
  // data değişkenini bağımlılık dizisine ekleyin
  useEffect(() => {
    setVeri(data);
  }, [data]); // <-- Buraya data ekleniyor
    ...
    <>
      <div className="nav d-flex justify-content-center gap-3 p-4 flex-column align-items-center flex-wrap">
        <div className="d-flex gap-3 flex-wrap justify-content-center">
          <button className="btn" onClick={handleStudents}>
            Students
          </button>
          <button className="btn" onClick={handleStaff}>
            Staff
          </button>
        </div>
        <div className="d-flex gap-3 flex-wrap justify-content-center">
          <button className="btn" onClick={handleGryffindor}>
            Gryffindor
          </button>
          <button className="btn" onClick={handleSlytherin}>
            Slytherin
          </button>
          <button className="btn" onClick={handleHufflepuff}>
            Hufflepuff
          </button>
          <button className="btn" onClick={handleRavenclaw}>
            Ravenclaw
          </button>
        </div>
      </div>
